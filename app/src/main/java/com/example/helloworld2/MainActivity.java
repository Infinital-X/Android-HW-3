...
public class MainActivity extends AppCompatActivity {
    ...
    private List<WishlistItem> generateSampleWishlistItems() {
        ...
        items.add(new WishlistItem("PlayStation 5", 499.99, R.drawable.skyrex));
        items.add(new WishlistItem("Nintendo Switch", 1199.99, R.drawable.garr));
        items.add(new WishlistItem("XBOX SERIES X", 10.99, R.drawable.dune));
        return items;
    }
